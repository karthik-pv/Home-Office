...
export const ADD_SCHEME_MAPPER_URL = "/addSchemeMapperData";
...
export const GET_SOLD_XIRR = "/transactions/getSoldUnitsXirr";
...
export const GET_ABS_RETURN_SOLD = "/transactions/getSoldUnitsAbsReturn";
